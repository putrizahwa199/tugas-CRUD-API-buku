    ...
    <div class="mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=koneksinew.php");//5 : detik
                }
                ?>
                <?php
                if ($sukses) {
                ...
                <?php
                    header("refresh:5;url=koneksinew.php");
                }
                ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="koneksinew.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="koneksinew.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
